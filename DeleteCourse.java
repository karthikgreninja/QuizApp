...
public class DeleteCourse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CourseId = (EditText) findViewById(R.id.etDelCourseID);
        CourseId.addTextChangedListener(mTextWatcher);
        del = (Button) findViewById(R.id.btnDelCourse);
        checkFieldsForEmptyValues();
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    URL url = new URL("http://192.168.43.235/QuizApp/DelCourse.php?String1=" + CID);
